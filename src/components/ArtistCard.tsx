...
//   return (
//     <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border border-gray-100 group">
//       {/* Image Section */}
//       <div className="relative h-56 overflow-hidden">
//         <div className="w-full h-full bg-gradient-to-br from-pink-100 to-purple-100 flex items-center justify-center">
//           <div className="w-20 h-20 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg">
//             {artist.name
//               .split(" ")
//               .map((n) => n[0])
//               .join("")}
...
//           <span className="font-bold text-pink-600">${artist.price}</span>
//         </div>
